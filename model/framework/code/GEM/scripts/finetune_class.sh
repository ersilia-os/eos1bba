...
#source ~/.bashrc  #I'm not sure the point of this lane...edit this. 
...
compound_encoder_config="model_configs/geognn_l8.json"    #edit this line
init_model="./pretrain_models-chemrl_gem/class.pdparams"   #edit this line
log_prefix="log/pretrain"  #edit this line
thread_num=4
count=0
for dataset in $datasets; do
	echo "==> $dataset"
	data_path="./chemrl_downstream_datasets/$dataset"  #edit this line
	cached_data_path="./cached_data/$dataset"  #edit this line
	if [ ! -f "$cached_data_path.done" ]; then
		rm -r $cached_data_path
		python finetune_class.py \   #edit this line depending on where this is moved
				--task=data \
				--num_workers=10 \
				...
				--model_config="model_configs/down_mlp2.json"  #edit this line
		if [ $? -ne 0 ]; then
